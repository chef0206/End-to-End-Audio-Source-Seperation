...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model', type=str, default='/Users/sakshisingh/Files/Courses/DeepLearning/project-code/wave2/checkpoints/waveunet/checkpoint_195',
    ...
    parser.add_argument('--input', type=str, default = "/Users/sakshisingh/Files/Courses/DeepLearning/project-code/wave2/audio_examples/Cristina Vane - So Easy/mix.mp3",
                        help="Path to input mixture to be separated")
    parser.add_argument('--output', type=str, default='/Users/sakshisingh/Files/Courses/DeepLearning/project-code/wave2/output', help="Output path (same folder as input path if not set)")
